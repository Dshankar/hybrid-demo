...
var btn = Button(controller, 184, 150, 200, 80); 
...
var btn3a = Button(survey1, 100, 180, 150, 80); 
btn3a.setBackgroundColor(Color(0.7,0.7,0.7,1)); 
btn3a.setTitle('Yes'); 
survey1.view.addSubview(btn3a);
var btn3b = Button(survey1, 318, 180, 150, 80); 
